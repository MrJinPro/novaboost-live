...
function summarizeRoomInfo(roomInfo: unknown) {
  return {
    ...
    live_room: getValueAtPath(roomInfo, ["data", "liveRoom"]) ?? getValueAtPath(roomInfo, ["data", "room"]),
    ...
    user_count: extractNumber(roomInfo, [
      ...
      ["liveRoomUserInfo", "liveRoom", "stats", "totalUserCount"],
      ["liveRoom", "user_count"],
      ["liveRoom", "stats", "user_count"],
      ["liveRoom", "stats", "totalUserCount"],
    ]),
  ...
  async fetchSnapshot(streamer: TrackedStreamer): Promise<TrackingSnapshot> {
    ...
    try {
      ...
      const viewerCount = extractNumber(roomInfo, [
        ...
        // webcast/room/info/ API uses data.room (not data.liveRoom)
        ["data", "room", "user_count"],
        ["data", "room", "stats", "user_count"],
        ["data", "room", "stats", "totalUserCount"],
        ["data", "user_count"],
        // api-live/user/room/ uses data.liveRoom
        ["data", "liveRoom", "user_count"],
        ["data", "liveRoom", "stats", "user_count"],
        ["data", "liveRoom", "stats", "viewer_count"],
        ["data", "liveRoom", "stats", "userCount"],
        ["data", "liveRoom", "stats", "totalUserCount"],
        // liveRoomUserInfo structure (HTML scraping)
        ["liveRoomUserInfo", "liveRoom", "user_count"],
        ["liveRoomUserInfo", "liveRoom", "stats", "user_count"],
        ["liveRoomUserInfo", "liveRoom", "stats", "viewer_count"],
        ["liveRoomUserInfo", "liveRoom", "stats", "userCount"],
        ["liveRoomUserInfo", "liveRoom", "stats", "totalUserCount"],
        // flat liveRoom at top level
        ["liveRoom", "user_count"],
        ["liveRoom", "stats", "user_count"],
        ["liveRoom", "stats", "totalUserCount"],
      ]);
