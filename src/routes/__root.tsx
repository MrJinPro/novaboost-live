...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "NovaBoost Live — Двигатель трафика для TikTok-стримов" },
      { name: "description", content: "NovaBoost Live распределяет внимание зрителей в реальном времени и помогает стримерам получать больше зрителей в момент выхода в эфир." },
      { name: "author", content: "NovaBoost" },
      { property: "og:title", content: "NovaBoost Live" },
      { property: "og:description", content: "Двигатель трафика для TikTok live-стримов" },
